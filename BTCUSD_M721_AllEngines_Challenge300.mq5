//+------------------------------------------------------------------+
//| BTCUSD_M721_AllEngines_Challenge300.mq5                         |
//| M721: M719 + faster BE ($1 activation)
//+------------------------------------------------------------------+
#property strict
...
input string InpBotComment                  = "BTCUSD M721 AllEngines";
input int InpMagicNumber                    = 721;
...
int OnInit()
{
   ...
   {
      Print("M721 init failed: indicator handle creation failed.");
      return INIT_FAILED;
   }
   ...
   lastStatus = "M721 ready. M719 + fast BE $1.";
   ShowDashboard();
...
{
   return "M721_" + prefix + "_" + IntegerToString(ticket);
}

//+------------------------------------------------------------------+
string ChartLblName(const string prefix, const ulong ticket)
{
   return "M721_" + prefix + "_LBL_" + IntegerToString(ticket);
}
