//+------------------------------------------------------------------+
//| BTCUSD_M718_AllEngines_Challenge300.mq5                         |
//| M718: Early entry filter + balanced activity
//+------------------------------------------------------------------+
#property strict
...
input string InpBotComment                  = "BTCUSD M718 AllEngines";
input int InpMagicNumber                    = 718;
...
int OnInit()
{
   ...
   {
      Print("M718 init failed: indicator handle creation failed.");
      return INIT_FAILED;
   }
   ...
   lastStatus = "M718 ready. Early filter + balanced activity.";
   ShowDashboard();
...
{
   return "M718_" + prefix + "_" + IntegerToString(ticket);
}

//+------------------------------------------------------------------+
string ChartLblName(const string prefix, const ulong ticket)
{
   return "M718_" + prefix + "_LBL_" + IntegerToString(ticket);
}
...
void ShowDashboard()
{
   ...
   const double dayProfit = GetMyDayProfit();
   string text = "";
   text += "=== BTCUSD M718 Early Filter + Active ===\n";
